<?php ?>
<!-- File: app/View/SanitizeStatus/admin_edit.ctp -->
<div class="top">
	<h1><?php echo __('Edit %s Status', __('Sanitize')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('SanitizeStatus');?>
		    <fieldset>
		        <legend><?php echo __('Edit %s Status', __('Sanitize')); ?></legend>
		    	<?php
		    ...
		    <fieldset>
				...
				echo $this->Form->input('threshold', array(
					...
					'div' => array('class' => 'third'),
					'after' => $this->Html->tag('span', __('How many %s should be assigned to this %s before an email is sent.', __('Media'), __('Sanitize Status'))),
				));
		...
		<?php echo $this->Form->end(__('Save %s Status', __('Sanitize'))); ?>
	</div>
</div>